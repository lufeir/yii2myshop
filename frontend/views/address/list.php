        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src=<?php echo \Yii::getAlias('@web')?>"/images/list_hot1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src=<?php echo \Yii::getAlias('@web')?>"/images/list_hot2.jpg" alt="" /></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><img src=<?php echo \Yii::getAlias('@web')?>"/images/list_hot3.jpg" alt="" /></a></dt>
