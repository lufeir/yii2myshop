...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data_goood_id="<?=$model['id']?>">
            <td class="col1"><a href=""><?= \yii\helpers\Html::img('http://admin.yii2shop.com/'.$model['logo'])?></a>  <strong><a href="">【1111购物狂欢节】<?=$model['name']?></a></strong></td>
            ...
            <?php $counts+=($model['shop_price']*$model['amount']);?>
        </tr>
        <?php endforeach;?>
    ...
    <div class="cart_btn w990 bc mt10">
        ...
        <a href="http://www.yii2shop.com/cart/order-index.html" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
<?php
...
<<<JS
  $(".reduce_num,.add_num").click(function() {
      var goods_id=$(this).closest('tr').attr('data_goood_id');
