        ...
        <div class="topnav_right fr">
            <ul>
                ...
                <?php if(!\Yii::$app->user->isGuest){
                    echo '[<a href="http://www.yii2shop.com/user/logout.html">注销'.\Yii::$app->user->identity->username.'</a>]';
                }else{
                    echo ' [<a href="http://www.yii2shop.com/user/login.html">登录</a>] [<a href="http://www.yii2shop.com/user/register.html">免费注册</a>] ';
                }
...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
                ...
                <dd>
                    <div class="prompt">
                        ...
                        if(!\Yii::$app->user->isGuest){
                            ...
                            echo ' 您好，请[<a href="http://www.yii2shop.com/user/login.html">登录</a> ';
                        }
                        ?>
                    </div>
        ...
        <div class="cart fl">
            <dl>
                <dt>
                    <a href="http://www.yii2shop.com/cart/index.html">去购物车结算</a>
                    <b></b>
                </dt>
                <dd>
                    <div class="prompt">
    ...
    <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
        <?php echo \frontend\widgets\CategorysWidgets::widget();?>
        <!--  商品分类部分 end-->

        <div class="navitems fl">
            <ul class="fl">
                <li class="current"><a href="http://www.yii2shop.com/">首页</a></li>
                <li><a href="">电脑频道</a></li>
                <li><a href="">家用电器</a></li>
                <li><a href="">品牌大全</a></li>
                <li><a href="">团购</a></li>
